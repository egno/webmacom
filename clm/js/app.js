            ...
            case "w_driver_worktime_month":
                {
                    ...
                    for (key in o) {
                        if (o.hasOwnProperty(key)) {
                            ...
                            result = result + "<td>" + hrefnvl(o[key].days_total, "?t=w_waybills_month&ym=" + ym + "&w=car=$$" + o[key].car + "$$ and driver=$$" + o[key].driver + "$$", 0, 'Открыть путевые листы') + "</td>";
                            result = result + "<td>" + hrefnvl(o[key].days_work, "?t=w_waybills_month&ym=" + ym + "&w=car=$$" + o[key].car + "$$ and driver=$$" + o[key].driver + "$$ and hours_work > 0", 0, 'Открыть путевые листы') + "</td>";
                            result = result + "<td>" + hrefnvl(o[key].days_repair, "?t=w_waybills_month&ym=" + ym + "&w=car=$$" + o[key].car + "$$ and driver=$$" + o[key].driver + "$$ and hours_repair > 0", 0, 'Открыть путевые листы') + "</td>";
                            result = result + "<td>" + hrefnvl(o[key].hours_total, "?t=w_waybills_month&ym=" + ym + "&w=car=$$" + o[key].car + "$$ and driver=$$" + o[key].driver + "$$", 0, 'Открыть путевые листы') + "</td>";
                            result = result + "<td>" + hrefnvl(o[key].hours_work, "?t=w_waybills_month&ym=" + ym + "&w=car=$$" + o[key].car + "$$ and driver=$$" + o[key].driver + "$$ and hours_work > 0", 0, 'Открыть путевые листы') + "</td>";
                            result = result + "<td>" + hrefnvl(o[key].hours_repair, "?t=w_waybills_month&ym=" + ym + "&w=car=$$" + o[key].car + "$$ and driver=$$" + o[key].driver + "$$ and hours_repair > 0", 0, 'Открыть путевые листы') + "</td>";
                            result = result + "</tr>";
                        ...
                        if (o.hasOwnProperty(key)) {
                            if ((old.workplace !== o[key].workplace)) {
                                if (old.workplace !== undefined) {
                                    ...
                                    result += "<td>" + hrefnvl(subtotal[0], "?t=w_waybills_month&ym=" + ym + "&w=workplace=$$" + o[key].workplace + "$$", 0, 'Открыть Путевые листы') + "</td>";
                                    result += "<td>&nbsp;</td>";
